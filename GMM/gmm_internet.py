...
class GMM:
    # source: http://ethen8181.github.io/machine-learning/clustering/GMM/GMM.html
    """
...
if __name__ == "__main__":
    ...
    gmm = GMM(n_components = 3, n_iters = 1000, tol = 1e-100, seed = 4)
    gmm.fit(data)
    plt.scatter(data[:, 0], data[:, 1], c="blue")
    plt.scatter(gmm.means[:, 0], gmm.means[:, 1], c="red")
